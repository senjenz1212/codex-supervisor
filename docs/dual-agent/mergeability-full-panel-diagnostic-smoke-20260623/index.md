# Dual-Agent Artifacts: mergeability-full-panel-diagnostic-smoke-20260623
...
- `execution`: 27 event(s)
- `implementation_plan`: 50 event(s)
- `issues_review`: 15 event(s)
- `outcome_review`: 26 event(s)
- `prd_review`: 8 event(s)
- `tdd_review`: 51 event(s)
- `unknown`: 24 event(s)
