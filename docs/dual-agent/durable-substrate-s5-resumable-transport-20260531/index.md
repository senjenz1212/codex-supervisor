# Dual-Agent Artifacts: durable-substrate-s5-resumable-transport-20260531
...
- `execution`: 43 event(s)
- `implementation_plan`: 19 event(s)
- `issues_review`: 6 event(s)
- `outcome_review`: 36 event(s)
- `prd_review`: 6 event(s)
- `tdd_review`: 9 event(s)
- `unknown`: 7 event(s)
- `workflow_start`: 7 event(s)
