# Dual-Agent Artifacts: durable-evaluator-replay-corpus-20260610
...
- `execution`: 8 event(s)
- `implementation_plan`: 31 event(s)
- `issues_review`: 6 event(s)
- `outcome_review`: 16 event(s)
- `prd_review`: 14 event(s)
- `tdd_review`: 11 event(s)
- `unknown`: 33 event(s)
