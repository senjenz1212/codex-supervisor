...
| Replay schema version drift | `test_replay_schema_versions_accept_current_manifest_versions`, `test_replay_schema_versions_accept_real_exported_manifest_keys`, `test_replay_schema_versions_map_known_forward_migration`, `test_replay_schema_versions_reject_unknown_future_versions`, and `test_export_dual_agent_run_artifacts_writes_replay_manifest_with_handoff_content` cover current exported manifests, legacy migration mapping, future-version rejection, and artifact-export compatibility checks. | Covered |
